  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="tv-focusable flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-zinc-800/90 hover:bg-zinc-700 text-zinc-300 hover:text-white border border-zinc-700/60 text-xs font-bold transition-all cursor-pointer shadow-sm"
      ...
      {isOpen && (
        <div
          className="absolute left-0 mt-2 w-64 bg-zinc-900/95 border border-zinc-700/80 rounded-2xl shadow-2xl p-2 z-50 animate-scale-up space-y-1 backdrop-blur-xl"
          dir="rtl"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="px-2.5 py-1 border-b border-zinc-800">
            <span className="text-[11px] font-bold text-zinc-200 block">انتخاب کیفیت جهت کپی:</span>
